...
namespace XHFrameWork
{
    ...
    public class UIManager : Singleton<UIManager>
    {
        ...
        public void OpenUI(EnumUIType[] uiTypes, string loadPath = null)
        {
            OpenUI(false, uiTypes, loadPath, null);
        }
        ...
        public void OpenUI(EnumUIType uiType, string loadPath = null, params object[] uiObjParams)
        {
            EnumUIType[] uiTypes = new EnumUIType[1];
            uiTypes[0] = uiType;
            OpenUI(false, uiTypes, loadPath, uiObjParams);
        }
        ...
        /// </summary>
        /// <param name="uiTypes">User interface types.</param>
        public void OpenUICloseOthers(EnumUIType[] uiTypes, string loadPath = null)
        {
            OpenUI(true, uiTypes, loadPath, null);
        }
        ...
        /// <param name="uiType">User interface type.</param>
        /// <param name="uiObjParams">User interface object parameters.</param>
        public void OpenUICloseOthers(EnumUIType uiType, string loadPath = null, params object[] uiObjParams)
        {
            EnumUIType[] uiTypes = new EnumUIType[1];
            uiTypes[0] = uiType;
            OpenUI(true, uiTypes, loadPath, uiObjParams);
        }
        ...
        private void OpenUI(bool _isCloseOthers, EnumUIType[] _uiTypes, string loadPath = null, params object[] _uiParams)
        {
            // Close Others UI.
            if (_isCloseOthers)
            {
            ...
            {
                CoroutineController.Instance.StartCoroutine(AsyncLoadData(loadPath));
            }
        }
